  ...
  //Creating resserved account 
           ...
           if (isset($user_account_name) && isset($user_account_number) && isset($user_bank_name)){
            if (!empty($user_account_name) && !empty($user_account_number) && !empty($user_bank_name)){
                ...
                $monniify_info = "INSERT INTO monnify (email, account_name, account_number, bank_name, account_ref, reserv_ref ) VALUES ('$email', '$user_account_name', '$user_account_number', '$user_bank_name', '$account_ref', '$reserve_ref' )";

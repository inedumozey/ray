 <?php require("header.php"); ?>
    ...
    if ($MTN_LOCK=="OFF" || $ceov=="topuser" && $activate==0){
      ...
      $mtn_opt='<option value="MTN">MTN - '.$m_discount.'%</option>';
    }
    ...
    if ($GLO_LOCK=="OFF" || $ceov=="topuser" && $activate==0){
      ...
      $glo_opt='<option value="GLO">GLO - '.$g_discount.'%</option>';
    }
    ...
    if ($AIRTEL_LOCK=="OFF" || $ceov=="topuser" && $activate==0){
      ...
      $airtel_opt='<option value="AIRTEL">AIRTEL - '.$a_discount.'%</option>';
    }
    ...
    if ($MOBILE_LOCK=="OFF" || $ceov=="topuser" && $activate==0){
      ...
      $mobile_opt='<option value="ETISALAT">ETISALAT - '.$mo_discount.'%</option>';
    }
    ?>
...
<div style="padding:90px 15px 20px 15px" >
   ...
   <div class="box w3-card-4" style="border-radius: 5px 5px 0px 0px;">
      <span id="" style="font-weight: bold;font-size: 30px;">AIRTIME VTU <span style="float: right;" id="img_loader"></span></span>
   </div>
   <br>
      ...
      <br>
       <div class="alert" id="showAfterPayment" style="background-color: white;border: none;display: none;">
          ...
          <br>
           ...
           <center><h3>Transaction Successful</h3></center> 
      ...
      swal({
          ...
          .then((shallWe) => {
            ...
            $.ajax({
              ...
              url:"<?php echo $baseurl; ?>/payload/airtimepayment",
              method:"POST",
              data:{

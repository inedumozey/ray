...
if (isset($_POST['submit'])){
    ...
    $earner_price=$_POST['earner_price'];

    $update=mysqli_query($db, "UPDATE general_setting SET earner_price='".$earner_price."'");
    if ($update){
                ...
                <form name="sendrequest" id ="sendrequest" method="POST"> 
                   ...
                   <div class="form-group">
                    <label for="exampleInputEmail1">Becareful while changing price <span style="color:red">*</span></label>
                       <textarea class="form-control" required="required" name="earner_price" id="earner_price">
                        <?php echo $earner_price; ?>
                      </textarea>
                    </div>

...
$ddaa = mysqli_query($db,"SELECT * FROM mytransaction WHERE username='".$userid."' OR email='".$userid."' OR trx='".$userid."' ORDER BY id DESC LIMIT 20000");
...
<div class="alert" style="background-color:white;">
  ...
  <div>
   ...
   <form name="sendrequest" id ="sendrequest" method="POST"> 
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Email Address/Username/Ref No. <span style="color:red">*</span></label>
